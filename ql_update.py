...
if __name__ == "__main__":
    ...
    if os.path.exists('/ql/data/scripts/bingbinghj_NeteaseCloudMusicTasks'):
        data_path = '/ql/data/'
    elif os.path.exists('/ql/scripts/bingbinghj_NeteaseCloudMusicTasks'):
        data_path = '/ql/'
    else:
        print('未找到路径，请尝试升级青龙')
        exit(1)
    
    scripts_config =  data_path + 'scripts/bingbinghj_NeteaseCloudMusicTasks/config.json'
    old_config = data_path + 'scripts/bingbinghj_NeteaseCloudMusicTasks/config.old.json'
    example_config = data_path + 'scripts/bingbinghj_NeteaseCloudMusicTasks/config.example.json'
    repo_config = data_path + 'repo/bingbinghj_NeteaseCloudMusicTasks/config.example.json'
    dependencies = data_path + 'repo/bingbinghj_NeteaseCloudMusicTasks/requirements.txt'
    if os.path.exists(scripts_config):
        ...
        print('更新配置文件...')
        os.system('python3 {}scripts/bingbinghj_NeteaseCloudMusicTasks/updateconfig.py {} {} {}'.format(
